...
def signup_form(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect("/en/signup")
...
@login_required(login_url="/en/login")  # Check login
def user_update(request):
    if request.method == "POST":
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            return HttpResponseRedirect("/en/user")
    else:
        category = Category.objects.all()
...
def user_password(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect("/en/user/password")
    else:
        # category = Category.objects.all()
...
def user_deletecomment(request, id):
    ...
    return HttpResponseRedirect("/en/user/comments")
